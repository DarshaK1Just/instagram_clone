...
import { CameraIcon } from "@headlessui/react/outline";
...
function Modal() {
    ...
    const [open, setOpen] = useRecoilState(nodalState);
    ...
    const uploadPost = async() => {
        ...
        await uploadString(imageRef, selectedFile, "data_url").then(async snepshot => {
    ...
    return ( <
        ...
        div className = "mt-2" >
        <
        input className = "boarder-none focus:ring-0 w-full text-center"
        type = "text"
        ref = { captionRef }
